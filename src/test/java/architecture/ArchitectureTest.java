...
@AnalyzeClasses (packages = "be.kdg.airene", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
	...
	void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
		...
		JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.airene");
