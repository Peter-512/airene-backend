...
@AllArgsConstructor
@Slf4j
public class MessageReceiverDev implements ReceivePredictionsPort, ReceiveDataBatchesPort {
		...
		private final String QUEUE_PREDICTION_NAME = "prediction-cute-dev";
		private final String QUEUE_DATA_NAME = "clean-data-queue-dev";

		private final JavaType listDataType;
		private final JavaType listPredictionType;
		private final JavaType listLocationType;
		@Autowired
		public MessageReceiverDev(SaveDataEntryBatchesUseCase batchesUseCase, SavePredictionsUseCase predictionsUseCase, AnomalyDetectedUseCase anomalyDetectedUseCase, ObjectMapper objectMapper) {
